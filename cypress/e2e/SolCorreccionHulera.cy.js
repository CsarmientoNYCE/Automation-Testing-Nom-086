describe('Test 0004 - Correction Request', () => {
    it('Fill Correction Request', () => {
     cy.visit('http://148.244.173.87/_layouts/15/APCVWPLogin/Default.aspx');
        ...
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_rblTipoDeCertificacion_4').first().check();
        ...
        //change "Aduana(s)"
        //it's shows the "Aduana(s)" in "Aduanas dice"
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_btnAgregarAduanas').click();
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_SeleccionarDatos1_lbSeleccionados').select(['AGUA PRIETA','CD. JUAREZ']);
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_SeleccionarDatos1_btnQuitar').click().then(function(){
            cy.wait(4000);
        });
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_SeleccionarDatos1_lbSeleccionar').select(['NOGALES','REYNOSA']);
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_SeleccionarDatos1_btnAgregar').click().then(function(){
            cy.wait(4000);
        });
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_SeleccionarDatos1_btnAceptar').click().then(function(){
        ...
        //change "Capacidad de carga"
        //it's shows the "Capacidad de carga" in "Capacidad de carga dice"
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_txtCapacidadCarga').clear();
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_txtCapacidadCarga').type('2');


        //change "Laboratorio que realizó las pruebas"
        //it's shows the "Laboratorio que realizó las pruebas" in "Laboratorio que realizó las pruebas dice"
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_ddlLaboratorioPruebas').select('83');


        //change "N. Informe de resultados de pruebas"
        //it's shows the "N. Informe de resultados de pruebas" in "N. Informe de resultados de pruebas dice"
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_txtNInformeResultados').clear();
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_txtNInformeResultados').type('Info0012 Cypress');


        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_txtMotivoSol').type('Pruebas Cypress');

        //this button is for save the information on the Request
        // cy.get('#btnGuardar').click();

        //this button is for cancel the request
        cy.get('#ctl00_ctl39_g_efd03997_8d48_4338_9aef_d3f50ef453fc_ctl00_btnCancelar').click();
    });
   });